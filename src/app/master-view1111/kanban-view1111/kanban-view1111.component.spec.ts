...
import { KanbanView1111Component } from './kanban-view1111.component';

describe('KanbanView1111Component', () => {
  let component: KanbanView1111Component;
  let fixture: ComponentFixture<KanbanView1111Component>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ KanbanView1111Component ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(KanbanView1111Component);
